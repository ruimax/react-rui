...
RuiDom.render = (vdom, container) => {
  ...
  if (typeof vdom.type === 'function') {
    ...
    // 判断是class组件
    if (Component.isPrototypeOf(vdom.type)) { // 不能用instanceof, instanceof用于判断是否是某个类的实例，检查的是Component.prototype,isPropertyOf检查的是Component
